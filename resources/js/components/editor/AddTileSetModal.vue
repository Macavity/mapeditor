        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Add TileSet to Map</h5>
                ...
                <div class="modal-body">
                    <form>
                        <div class="mb-3">
                            ...
                            <input v-model="url" id="tileSetUrl" type="text" class="form-control" aria-describedby="tileSetUrlHelp" />
                            <div id="tileSetUrlHelp" class="form-text">Enter the URL to the external TileSet</div>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button @click="close" type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button @click="confirm" type="button" class="btn btn-primary" :class="{ 'btn-disabled': url.length === 0 }">Add</button>
                </div>
            </div>
        </div>
    </div>
